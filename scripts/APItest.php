...
function search($source){
	...
	curl_setopt_array($curl, [
		...
		CURLOPT_URL =>"http://open.api.ebay.com/shopping?callname=FindProducts&responseiencoding=JSON&siteid=0&version=967&QueryKeywords=$source&AvailableItemsOnly=true&MaxEntries=5&appid=$apikey",
