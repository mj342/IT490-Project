...
<<<<<<< HEAD
	...
	{ 
	 ...
	 if ( $count_rows > 0 ) 
	 { 
	 return "This item with Product ID: $product_id already exists in my collection feature for username: $username - Pick a different Product !!!";
	 }
	 ...
	 or die(mysqli_error($database_connection)) ;
		...
		return "Successfully added product: $product_id to my collection feature for username: $username ";
	}
	...
	{	
	 ...
	 "ramblers") ;
		 ...
		 $query2 = "select * from shoes, collections where
		 collections.productID = shoes.productID and
		 collections.username = '$username'" ;
		
		 //Executing SQL Query
		 $query_result2 = mysqli_query($database_connection, $query2)
		 or die(mysqli_error($database_connection)) ;

		 $data = mysqli_fetch_all($query_result2 , MYSQLI_ASSOC);
	...
	{ 
	 ...
	 return "Successfully removed $product_id from my collection feature for username: $username ";
	}
...
exit();
?>
>>>>>>> 1ab5c72d34394d7bfe2a8b37bcbe908b489be286
